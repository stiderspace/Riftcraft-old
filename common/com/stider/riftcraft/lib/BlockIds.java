...
public class BlockIds {
	...
	public static int WARPEDBLOCK_DEFAULT = 2500;
	public static int STABILIZER_DEFAULT = 2501;
	public static int DWARFSTAR_DEFAULT = 2502;
	public static int RIFT_ENGINE_DEFAULT = 2503;
    ...
    public static int DWARFSTAR;
    public static int RIFT_ENGINE;
